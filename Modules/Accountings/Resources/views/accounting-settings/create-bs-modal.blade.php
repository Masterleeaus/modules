...
<div class="modal-header">
    <h5 class="modal-title" id="modelHeading">@lang('app.add') @lang('accountings::app.menu.bs')</h5>
        ...
        <x-form id="addTicketChannel" method="POST" class="ajax-form">
            <div class="form-body">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <x-forms.text fieldId="bs_name" :fieldLabel="__('accountings::app.menu.bsName')" fieldName="bs_name" fieldRequired="true"
                            :fieldPlaceholder="__('')">
                        </x-forms.text>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <x-forms.label class="mt-3" fieldId="parent_label" :fieldLabel="__('accountings::app.menu.bsType')" fieldName="parent_label">
                        </x-forms.label>
                        <x-forms.input-group>
                    ...
                    <div class="col-md-6">
                        <x-forms.label class="mt-3" fieldId="parent_label" :fieldLabel="__('accountings::app.menu.bsGroup')" fieldName="parent_label">
                        </x-forms.label>
                        <x-forms.input-group>
