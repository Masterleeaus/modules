...
@php
    $addInvoicesPermission = user()->permission('add_acc');
@endphp
    ...
    <x-filters.filter-box>
        ...
        <x-filters.more-filter-box>
            <div class="more-filter-items">
                <label class="f-14 text-dark-grey mb-12 text-capitalize" for="usr">@lang('accountings::app.menu.journalType')</label>
                    ...
                    <div class="select-others">
                        <select class="form-control select-picker" name="type" id="type"
                            ...
                            @foreach ($type as $item)
                                <option value="{{ $item->id }}">{{ $item->type_journal }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
        ...
        <div class="d-block d-lg-flex d-md-flex">
            <div id="table-actions" class="flex-grow-1 align-items-center mb-2 mb-lg-0 mb-md-0">
                @if ($addInvoicesPermission == 'all')
                    <x-forms.link-primary :link="route('journal.create')" class="mr-3 float-left mb-2 mb-lg-0 mb-md-0" icon="plus">
                        @lang('accountings::app.acc.addJournal')
