...
class AssetAllocationController extends Controller
{
    ...
    public function index(Request $request)
    {
            ...
            return Datatables::of($asset_allocated)
                ->addColumn('action', function ($row) {
                    ...
                    if ($row->revoked_quantity != $row->quantity) {
                        $html .= '<li>
                                    <a data-href="'.action([\Modules\Asset\Http\Controllers\AssetAllocationController::class, 'edit'], [$row->id]).'" class="cursor-pointer edit_allocated_asset">
                    ...
                    $html .= '<li>
                                <a data-href="'.action([\Modules\Asset\Http\Controllers\AssetAllocationController::class, 'destroy'], [$row->id]).'"  id="delete_allocated_asset" class="cursor-pointer">
                    ...
                    if ($row->revoked_quantity != $row->quantity) {
                        $html .= '<li>
                                <a data-href="'.action([\Modules\Asset\Http\Controllers\RevokeAllocatedAssetController::class, 'create'], ['id' => $row->id]).'" class="cursor-pointer revoke_allocated_asset">
                                    <i class="fas fa-history"></i>
                                    '.__('asset::lang.revoke').'
                                </a>
                            </li>';
                    }
        ...
        return view('asset::asset_allocation.index');
    }
    ...
    public function create()
    {
        ...
        if (request()->ajax()) {
            ...
            return view('asset::asset_allocation.create')
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()
                ->action([\Modules\Asset\Http\Controllers\AssetAllocationController::class, 'index'])
    ...
    public function edit($id)
    {
        ...
        if (request()->ajax()) {
            ...
            return view('asset::asset_allocation.edit')
