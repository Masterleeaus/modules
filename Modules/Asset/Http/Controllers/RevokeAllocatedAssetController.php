...
class RevokeAllocatedAssetController extends Controller
{
    ...
    public function index()
    {
            ...
            return Datatables::of($asset_allocated)
                ->addColumn('action', function ($row) {
                    ...
                    $html .= '<ul class="dropdown-menu dropdown-menu-left" role="menu">
                                <li>
                                    <a data-href="'.action([\Modules\Asset\Http\Controllers\RevokeAllocatedAssetController::class, 'destroy'], [$row->id]).'"  id="delete_revoked_asset" class="cursor-pointer">
        ...
        return view('asset::asset_revocation.index');
    }
    ...
    public function create(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            return view('asset::asset_revocation.create')
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()
                ->action([\Modules\Asset\Http\Controllers\RevokeAllocatedAssetController::class, 'index'])
