...
use Modules\CleanQuality\DataTables\ScheduleInspectionDataTable;
...
class ScheduleInspectionController extends AccountBaseController
{
    ...
    {
        abort_403(ModuleAccess::permissionLevel('edit_quality_control') != 'all');
    ...
    public function updateOtherData(Request $request, $id)
    {
        ...
        $items = (array) request()->items_name;
        $item_ids = (array) request()->item_ids;
        ...
        foreach ($items as $key => $item) {
            ...
            $invoiceItem->schedule_id = $schedule->id;
    ...
    {
        $viewInspectionPermission = ModuleAccess::permissionLevel('view_quality_control');
