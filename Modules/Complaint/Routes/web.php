...
Route::group(['middleware' => 'auth', 'prefix' => 'account'], function () {
    ...
    // Quality Issues workflow actions
    Route::post('complaint/{complaint}/resolve', [ComplaintController::class, 'resolve'])->name('complaint.resolve');
    Route::post('complaint/{complaint}/schedule-followup-inspection', [ComplaintController::class, 'scheduleFollowUpInspection'])->name('complaint.schedule_followup_inspection');
