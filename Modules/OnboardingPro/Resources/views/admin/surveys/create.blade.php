...
<div class="content-wrapper">
    <div class="row content-header">
        <div class="col-12">
            <h1 class="content-header-title">{{ __('onboardingpro::onboardingpro.add_survey') }}</h1>
        </div>
    </div>
    <div class="row">
        <div class="col-md-10">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('onboardingpro.admin.surveys.store') }}" method="POST" id="surveyForm">
                        @csrf
