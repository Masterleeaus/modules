...
namespace Modules\WorksuiteWorkOrders\Database\Seeders;

use Illuminate\Database\Seeder;
use Modules\WorksuiteWorkOrders\Entities\{WorkOrder, WOType, WOServiceAppointment, WOServiceTask, WOServicePart, ServiceTask, ServicePart};
