...
namespace Modules\WorksuiteWorkOrders\Http\Controllers;

use Illuminate\Routing\Controller;
use Illuminate\Http\RedirectResponse;
use Illuminate\View\View;
use Modules\WorksuiteWorkOrders\Entities\WorkOrder;
use Modules\WorksuiteWorkOrders\Events\WorkOrderCreated;
use Modules\WorksuiteWorkOrders\Events\WorkOrderUpdated;
use Modules\WorksuiteWorkOrders\Events\WorkOrderCompleted;
use Modules\WorksuiteWorkOrders\Http\Requests\StoreWorkOrderRequest;
use Modules\WorksuiteWorkOrders\Http\Requests\UpdateWorkOrderRequest;
...
class WorkOrderController extends Controller
{
    ...
    {
        $order = \Modules\WorksuiteWorkOrders\Entities\WorkOrder::with(['tasks'])->findOrFail($id);
