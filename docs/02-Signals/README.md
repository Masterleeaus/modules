...
# Agent 2 Docs — Edited Cumulative Set

This set preserves the existing 19 Agent 2 Titan docs and expands them in place using the project source blueprints, Worksuite AI/PWA architecture notes, and the uploaded Laravel reference material.

## What changed
- kept the original doc bodies
- appended missing architecture detail rather than replacing them
- expanded contracts, responsibilities, runtime flows, and checklists
- aligned module, AI, signal, workflow, communications, scheduling, PWA, security, and sync docs to the current Titan/Worksuite direction

## Source families used
- `Module-Plugin Blueprint.txt`
- `Full System Blueprint.txt`
- `Titan-Ready Worksuite Module Checklist (Developer Edition).txt`
- `worksuite_ai_pwa_docs.zip`
- uploaded Laravel reference PDFs for controller/service separation, routing, service container, queues, testing, and modular Laravel practice

## Included docs
- Titan_AI_Core_Architecture.md
- Titan_AI_Tool_Manifest_Spec.md
- Titan_Automation_Engine.md
- Titan_CMS_Manifest_Spec.md
- Titan_Communications_Engine.md
- Titan_Module_Blueprint.md
- Titan_Module_Install_Lifecycle.md
- Titan_Module_Manifest_and_Extension_Schema.md
- Titan_Module_Registry_Contract.md
- Titan_Observability_and_Doctor.md
- Titan_Omni_Channel_Architecture.md
- Titan_PWA_Surface_Architecture.md
- Titan_Platform_Engine_Layer.md
- Titan_Provider_and_Bootstrap_Registry.md
- Titan_Scheduling_Engine.md
- Titan_Security_Permissions_Audit.md
- Titan_Signals_Engine.md
- Titan_Sync_and_Offline_Runtime.md
- Titan_Workflow_Engine.md

---
## This pass

This pass deepens the thinner docs so the set behaves as one cumulative architecture pack instead of a list of separate notes.

### New emphasis
- acceptance criteria for each engine or contract
- anti-patterns that create drift between UI, API, automation, and AI
- explicit runtime boundaries between platform, module, and Filament ownership
- provider/bootstrap rules that keep the system inspectable by Doctor
- offline, sync, workflow, scheduling, and manifest invariants

## Reading order

1. `Titan_Platform_Engine_Layer.md`
2. `Titan_Module_Blueprint.md`
3. `Titan_Module_Manifest_and_Extension_Schema.md`
4. `Titan_Provider_and_Bootstrap_Registry.md`
5. `Titan_Signals_Engine.md`
6. `Titan_Automation_Engine.md`
7. `Titan_Workflow_Engine.md`
8. `Titan_Scheduling_Engine.md`
9. `Titan_AI_Core_Architecture.md`
10. channel, CMS, PWA, sync, security, and observability docs

## Global invariants across the set

- `company_id` is the tenant boundary.
- platform engines provide shared runtime services; modules keep domain truth.
- Filament is an operator shell, not the source of business rules.
- AI uses declared tools and manifests, never arbitrary internal methods.
- all state-changing flows should be auditable, retry-aware, and approval-capable where risk requires it.
- offline/runtime shells should sync bounded deltas, not mirror the whole database.
